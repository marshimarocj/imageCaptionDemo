...
"				<h1  style=\"font-weight:bold; font-family:champagne__limousines-webfont;\">Image Description:</h1>\n"
"				<p id=\"result\" style=\"font-weight:bold; font-size: 25px; font-family:champagne__limousines-webfont;\">" + jsonData["thumbs"][0][0] + "</p>\n"
"			</div>\n"
